...
class DatasetsCatalogoSeeder extends Seeder
{
    ...
    private function catalogo(): array
    {
        return [
            ...
            ['dataset_clave' => 'DS-07', 'sistema_origen' => 'spp',
                'nombre' => 'Medios de Verificación de la MIR',
                'descripcion' => 'Medios de verificación de cada indicador del MIR por programa presupuestal, con nombre, descripción, fuente, organismo responsable, URL de consulta y frecuencia de actualización.'],
