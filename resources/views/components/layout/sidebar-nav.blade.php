...
<x-ui.sidebar-group label="Transparencia" :active="request()->routeIs('transparencia.*')">
    <x-slot:icon>
    ...
    <x-slot:tooltip>
        <a href="{{ route('transparencia.datos-abiertos.index') }}" class="block py-1 hover:text-brand-light">Datos Abiertos</a>
    </x-slot:tooltip>

    <x-ui.sidebar-item href="{{ route('transparencia.datos-abiertos.index') }}" :active="request()->routeIs('transparencia.datos-abiertos.*')">
        Datos Abiertos
    </x-ui.sidebar-item>
</x-ui.sidebar-group>
@endcan
